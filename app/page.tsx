...
const OFFERS = [
  ...
  { id:2, title:'Buy 1 Get 1 Free',    vendor:'STUD-LOYAL Café',   category:'Coffee',       discount:'BOGO',    img:'☕', distance:'0.1 mi', expiry:'5 days', saves:98,  claimed:211 },
  ...
  { id:6, title:'500 Ft off any pizza', vendor:'Pizza Republic',   category:'Food & Drink', discount:'500 Ft',  img:'🍕', distance:'0.5 km', expiry:'1 nap',  saves:31,  claimed:19  },
];
...
const VENDOR_METRICS = [
  ...
  { label:'Avg. Basket Value', value:'5 500 Ft', delta:'+700 Ft', color:'text-purple-600' },
          ...
          <div>
            ...
            <footer className="bg-gray-900 text-gray-400 py-8 px-6 text-center text-sm">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="text-white font-bold text-base">STUD-LOYAL</span>
              </div>
              <p>© 2026 STUD-LOYAL. The student marketplace that just works.</p>
            </footer>
          </div>
        )}
          ...
          <div className="max-w-2xl mx-auto px-4 py-6">
            ...
            <div className="card bg-gradient-to-r from-brand-50 to-purple-50 border-brand-200 p-4 flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-xl font-black text-brand-700">46 550 Ft megtakarítva</p>
              </div>
