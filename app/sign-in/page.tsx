...
export default function SignInPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Fetch role and redirect — use window.location for a hard redirect so the
    // session cookie is picked up cleanly by the server on the next request.
    ...
    window.location.href = role === 'vendor' ? '/vendor' : role === 'admin' ? '/admin' : '/dashboard';
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-white font-bold text-xl">STUD-LOYAL</span>
          </Link>
