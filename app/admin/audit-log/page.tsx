...
const ACTION_OPTIONS = [
  ...
  'review_deleted', 'announcement_sent',
];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-4 mb-4 flex items-center gap-3 flex-wrap">
          ...
          <span className="text-xs font-semibold text-gray-500">Filter by action:</span>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
          {loading ? (
            ...
            <div className="text-center py-24">
              ...
              <p className="text-gray-400 font-medium">No audit entries yet.</p>
              <p className="text-xs text-gray-300 mt-1">Actions will appear here as admins make decisions.</p>
            </div>
          ) : (
                ...
                {entries.map((e) => (
                  <tr key={e.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-5 py-3 text-gray-500 whitespace-nowrap">
                      <span title={e.created_at}>{timeAgo(e.created_at)}</span>
                    </td>
